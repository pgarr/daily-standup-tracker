...
export const AUTH_REQUIRED_ROUTES = ["/dashboard", "/workspace", "/api/blocker", "/team-feed"];
...
export const WORKSPACE_REQUIRED_ROUTES = ["/dashboard", "/workspace/members", "/team-feed"];
