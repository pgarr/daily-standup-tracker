...
- [x] 4.1 npm run build passes — 4b25a2e
- [x] 4.2 npm run lint passes — 4b25a2e

#### Manual

- [x] 4.3 Team Lead sees Members link in Topbar navigating to /workspace/members — 4b25a2e
- [x] 4.4 Member does not see Members link in Topbar — 4b25a2e
